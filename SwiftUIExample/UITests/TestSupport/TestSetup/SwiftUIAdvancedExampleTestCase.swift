...
/// Reference-only base class showing the extended SwiftUI test configuration.
/// Existing SwiftUI tests intentionally do not inherit from this class.
class SwiftUIAdvancedExampleTestCase: XCEasyTestCase {
    ...
    override func beforeTest() {
        suite("SwiftUIAdvancedExampleUITests")
        tag("SwiftUI", "UI", "Advanced configuration")
        super.beforeTest()
    }
}
