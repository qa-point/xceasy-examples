...
@Marker("SwiftUI")
final class SwiftUIDynamicContentTests: SwiftUIExampleTestCase {
    @DisplayName("[SwiftUI] Recommendation card is initially absent")
    ...
    @DisplayName("[SwiftUI] Recommendation card appears after loading")
    ...
    @DisplayName("[SwiftUI] Recommendation details appear after expansion")
    ...
    @DisplayName("[SwiftUI] Recommendation card can be removed")
    @Story("Recommendation lifecycle")
    ...
    @DisplayName("[SwiftUI] Recommendation card can be restored")
    @Story("Recommendation lifecycle")
