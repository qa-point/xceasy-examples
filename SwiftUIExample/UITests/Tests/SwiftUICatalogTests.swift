...
@Feature("Catalog")
@Marker("SwiftUI")
final class SwiftUICatalogTests: SwiftUIExampleTestCase {
    @DisplayName("[SwiftUI] Catalog sorts products by ascending price")
    ...
    @DisplayName("[SwiftUI] Catalog sorts products by descending price")
    @Story("Product sorting")
    ...
    @DisplayName("[SwiftUI] Catalog filters products by search query")
    ...
    @DisplayName("[SwiftUI] Catalog shows an empty state for a missing product")
    @Story("Product search")
