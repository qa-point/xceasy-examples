...
@Feature("Components")
@Marker("UIKit")
final class UIKitComponentsTests: UIKitExampleTestCase {
    @DisplayName("[UIKit] Component input: {id}")
    ...
    @DisplayName("[UIKit] Component selections and collection state")
    ...
    @DisplayName("[UIKit] Stored banner POM resolves its replacement")
