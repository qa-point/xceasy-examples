...
@Feature("Overlays")
@Marker("UIKit")
final class UIKitOverlaysTests: UIKitExampleTestCase {
    @DisplayName("[UIKit] Confirmation alert is displayed")
    @Story("System alert")
    ...
    @DisplayName("[UIKit] Confirmation alert displays its result")
    @Story("System alert")
    ...
    @DisplayName("[UIKit] Feature sheet is displayed")
    @Story("Feature sheet")
    ...
    @DisplayName("[UIKit] Feature sheet is removed after closing")
    @Story("Feature sheet")
    ...
    @DisplayName("[UIKit] Toast appears and leaves the UI tree")
