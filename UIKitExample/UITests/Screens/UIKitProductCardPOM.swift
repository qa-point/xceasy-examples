...
/// One lazy product card from the current filtered UIKit catalogue.
struct UIKitProductCardPOM: XCEasyIndexedComponent {
    // MARK: - XCEasyIndexedComponent

    static var collection: XCEasyUIElement {
        find(identifier: "UIKitExample.Catalog.Product", desc: "Products")
    }
    ...
    var nameLabel: XCEasyUIElement {
        element.child(
                type: .staticText,
                identifier: "UIKitExample.Catalog.Product.Name",
    ...
    var detailsLabel: XCEasyUIElement {
        element.child(
                type: .staticText,
                identifier: "UIKitExample.Catalog.Product.Details",
