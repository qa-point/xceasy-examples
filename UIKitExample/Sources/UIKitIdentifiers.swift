...
/// Stable accessibility identifiers owned exclusively by the UIKit example.
enum UIKitIdentifiers {
    static let prefix = "UIKitExample"
    ...
    enum Components {
        ...
        static let title = "\(prefix).Components.Title"
        ...
        static let bannerSubtitle = "\(prefix).Components.Banner.Subtitle"
